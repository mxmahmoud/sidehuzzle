  ...
  return (
    <ScrollView style={[styles.root, { backgroundColor: c.surface_secondary }]} contentContainerStyle={styles.content}>
      <GlassCard>
        ...
        <Text style={[typeStyles.title, { color: c.text_primary }]}>My cards</Text>
      </GlassCard>
      <GlassCard>
        <View style={styles.cardRow}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={{ color: c.text_secondary, fontSize: 12 }}>Expires 12/26</Text>
          </View>
          <View style={[styles.defaultBadge]}>
            <Text style={{ color: '#fff', fontSize: 10, fontWeight: '700', textTransform: 'uppercase' }}>Default</Text>
          </View>
        </View>
      </GlassCard>
      <GlassCard>
...
const styles = StyleSheet.create({
  ...
  defaultBadge: { backgroundColor: '#4CAF50', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
})
