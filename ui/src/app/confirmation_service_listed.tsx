  ...
  return (
    <View style={[styles.root, { backgroundColor: c.surface_secondary }]}>
      <View style={styles.content}>
        <View style={[styles.iconWrap, { backgroundColor: 'rgba(255,94,168,0.18)' }]}>
          <Ionicons name="checkmark-circle" size={56} color={c.pin_worker} />
        </View>
        <Text style={[styles.eyebrow, { color: c.accent_primary }]}>Published</Text>
        <Text style={[typeStyles.title, { color: c.text_primary, textAlign: 'center' }]}>Your service is live</Text>
        <Text style={[typeStyles.body, { color: c.text_secondary, textAlign: 'center', lineHeight: 22 }]}>
          Customers in your area can now discover and contact you. Keep your profile updated to attract more requests.
        </Text>

        <View style={[styles.infoCard, { backgroundColor: c.surface_elevated, borderColor: c.border_subtle }]}>
          <View style={styles.infoRow}>
            <Ionicons name="star-outline" size={16} color={c.text_secondary} />
            <Text style={{ color: c.text_secondary, fontSize: 14 }}>Encourage clients to leave reviews</Text>
          </View>
          <View style={styles.infoRow}>
            <Ionicons name="chatbubbles-outline" size={16} color={c.text_secondary} />
            <Text style={{ color: c.text_secondary, fontSize: 14 }}>Respond promptly to requests</Text>
          </View>
        </View>
      </View>
      ...
      <View style={[styles.footer, { paddingBottom: insets.bottom + space.lg }]}>
        ...
        <Pressable
          ...
          accessibilityRole="button"
        >
          <Ionicons name="people-outline" size={18} color={c.accent_primary} />
          <Text style={[styles.secondaryBtnText, { color: c.accent_primary }]}>View requests</Text>
        </Pressable>
      </View>
    </View>
  );
